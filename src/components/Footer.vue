<template>
    <footer class="bg-white">
      <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div class="text-teal-600">
              <img  class="h-8" viewBox="0 0 28 24" :src="`/img/Logo_fitfinder.png`" alt="logo">
                <path
            ...
            <p class="mt-4 max-w-xs text-gray-500">
              FitFinder ipsum dolor, sit amet consectetur adipisicing elit. Esse non cupiditate quae nam
              molestias.
            </p>
        ...
        <p class="text-xs text-gray-500">&copy; 2022. Company FitFinder. All rights reserved.</p>
      </div>
    </footer>
  </template>